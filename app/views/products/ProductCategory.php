...
<main>
    <div class="container">
        <div class="filter-container">
            ...
            <a href="?sort=name-asc" class="filter-button <?= ($_GET['sort'] ?? '') === 'name-asc' ? 'active' : '' ?>">Tên A → Z</a>
            <a href="?sort=name-desc" class="filter-button <?= ($_GET['sort'] ?? '') === 'name-desc' ? 'active' : '' ?>">Tên Z → A</a>
            <a href="?sort=price-asc" class="filter-button <?= ($_GET['sort'] ?? '') === 'price-asc' ? 'active' : '' ?>">Giá tăng dần</a>
            <a href="?sort=price-desc" class="filter-button <?= ($_GET['sort'] ?? '') === 'price-desc' ? 'active' : '' ?>">Giá giảm dần</a>
            <a href="?sort=newest" class="filter-button <?= ($_GET['sort'] ?? '') === 'newest' ? 'active' : '' ?>">Hàng mới</a>
        </div>
